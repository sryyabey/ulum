                ...
                @can('kutup_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/surahs*") ? "menu-open" : "" }} {{ request()->is("admin/qurans*") ? "menu-open" : "" }} {{ request()->is("admin/languages*") ? "menu-open" : "" }} {{ request()->is("admin/translates*") ? "menu-open" : "" }} {{ request()->is("admin/notes*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('quran_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.qurans.index") }}" class="nav-link {{ request()->is("admin/qurans") || request()->is("admin/qurans/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-book">

                                        </i>
                                        <p>
                                            {{ trans('cruds.quran.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @endcan
                            @can('translate_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.translates.index") }}" class="nav-link {{ request()->is("admin/translates") || request()->is("admin/translates/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fab fa-font-awesome-flag">

                                        </i>
                                        <p>
                                            {{ trans('cruds.translate.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
